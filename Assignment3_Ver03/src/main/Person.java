...
/**
 * abstract class can contain methods and methods already implemented 
 */
abstract class Person {
     ...
     */
    //public Person(String password) { this.password = password; }
    ...
    public Person(String email, String name, String address, String gender, String password) {
        setName(name);
        this.email = email; //this.(refers to field) = referring to the parameter on RHS
        this.address = address;
        setGender(gender);
